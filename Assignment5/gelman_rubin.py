#Code that gets the chain with chi in the first collumn
#It is performs gelman_rubin test on the columns of the chain
import numpy as np
f = open("/Users/louis/Desktop/McGill/FALL 2022/PHYS 512/Assignment/5/phys512-2022/Assignment5/planck_chain_tauprior.txt", "r")
