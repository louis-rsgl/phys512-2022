...
pars=np.asarray([60,0.02,0.1,0.05,2.00e-9,1.0]) #test chisq is  15267.937968194292  for  2501  degrees of freedom.
pars=np.asarray([69, 0.022, 0.12,0.06, 2.1e-9, 0.95]) #q1 chisq is  3272.203604462886  for  2501  degrees of freedom.
...
planck_binned=np.loadtxt('Assignment5/COM_PowerSpect_CMB-TT-binned_R3.01.txt',skiprows=1)
